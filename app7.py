...
app = Flask(__name__)
app.secret_key = "super_secret_key"  # change to a random secret key
API_KEY = "60efbddb88dd2481343c67fc1140524c"  # ⬅️ Replace this with your actual API key
...
def index7():
    ...
    return render_template('index7.html', weather=weather_data, forecast=forecast_data,
